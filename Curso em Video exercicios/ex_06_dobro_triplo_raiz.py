...
# ---- sem variável ------ print(' O  Triplo do
# {} vale {}. \n A raiz quadrada de {} é igual a {:.2f}'.format(numero,
#
# (numero*3), numero, (numero**(1/2)))) ----- sem Variável ---- print(' O  Triplo do {} vale {}. \n A raiz quadrada
# de {} é igual a {:.2f}'.format(numero,(numero*3), numero, pow(numero, (1/2))))
